...
- 2 313 observations Panoramax sont versées, une par ouvrage — 3,9 % du recensement. Diamètre médian des ouvrages illustrés : 22,5 m, contre 24,5 m pour l'ensemble. Prises de vue de 2010 à 2026.
...
- **Le cadrage est filtré à 35°** (`Photo::CADRAGE_MAX_DEG`), soit à peu près la demi-ouverture d'un objectif courant. 457 observations sur 2 770 sont écartées, 16,5 %. Le seuil est inclusif : 35° passe, 36° non. Une ligne dépourvue d'`ecart_deg` est retenue.
- Le rejeu du fichier **retire** les observations devenues irrecevables, appariées par `(rond-point, url)` : c'est ainsi que les 457 déjà versées ont quitté les dossiers. Les observations jointes à la main ne sont jamais touchées. Un troisième passage ne retire plus rien.
- **Le seuil écarte aussi de bons clichés.** L'écart mesure l'axe de visée, pas la visibilité de l'ouvrage : à courte distance, un grand-angle cadre encore le rond-point malgré 40° d'écart. La fiche 517, Rond-Point de Segorbe, était parfaitement illustrée et sort du lot à 38°. Parmi les 457 écartées, 160 ont un `rapport` inférieur ou égal à 1,5, c'est-à-dire un objectif au ras de l'anneau. Croiser `ecart_deg` avec `rapport` conserverait ces cas — non fait.
