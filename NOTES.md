...
- **Environ un quart des observations sont des panoramiques équirectangulaires** (13 sur 50 échantillonnées) et s'affichent déformées, avec la bande de nadir de la caméra en bas de cadre. C'est le prix de la couverture : sur certaines dates, Panoramax n'a que du 360. Trois issues possibles, aucune retenue — les exclure et perdre des dates, les recadrer en vue rectilinéaire à partir du cap connu, ou les afficher dans une visionneuse.
